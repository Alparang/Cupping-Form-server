...
router.post('/edit', function(req,res,next){
    ...
    var ins_values =  [ins_user_num, ins_form_name, ins_fragrance, ins_flavor,
        ins_afterTaste, ins_acidity, ins_bodiness, ins_uniformity, ins_balance, ins_cleanCup,
        ins_sweetness, ins_overall, my_index]


    var sql = 'update evaluation_db set user_num = ?, form_name = ?, fragrance = ?, flavor = ?,' +
            'afterTaste = ?, acidity = ?, bodiness = ?, uniformity = ?, balance = ?, ' +
            'cleanCup = ?, sweetness = ?, overall = ? where evaluation_index = ?';
